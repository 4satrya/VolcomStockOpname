Public Class ClassStockTake
    ...
    Public Function queryVerTransMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        Else
            condition = ""
        End If
        Dim query As String = "SELECT st.id_wh_drawer, st.remark, c.id_comp,c.comp_number, c.comp_name, CONCAT(c.comp_number,' - ', c.comp_name) AS `comp`, c.address_primary,st.id_st_trans_ver, st.st_trans_ver_number, 

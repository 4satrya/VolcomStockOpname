...
Module Common
    ...
    Sub ReportStyleGridview(ByVal BandedGridView1 As DevExpress.XtraGrid.Views.Grid.GridView)
        ...
        BandedGridView1.AppearancePrint.FooterPanel.BackColor = Color.Transparent
        BandedGridView1.AppearancePrint.FooterPanel.ForeColor = Color.Black
        BandedGridView1.AppearancePrint.FooterPanel.Font = New Font("Segoe UI", 8.75, FontStyle.Bold)
    ...
    Sub exportToXLSDataAware(ByVal path_par As String, ByVal sheet_name_par As String, ByVal gc_par As DevExpress.XtraGrid.GridControl)

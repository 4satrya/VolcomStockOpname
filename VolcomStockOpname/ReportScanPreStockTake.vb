Public Class ReportScanPreStockTake
    Public Shared id_report As String = "-1"
    Public Shared dt As DataTable

    Private Sub ReportScanPreStockTake_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
